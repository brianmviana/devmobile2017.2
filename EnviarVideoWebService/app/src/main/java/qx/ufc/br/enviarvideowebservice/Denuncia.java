...
public class Denuncia implements Serializable {
	...
	private static final long serialVersionUID = 7562071325771408822L;
	...
	public Denuncia(Integer id, String descricao, Date data, Double longitude, Double latitude, String uriMidia,
			String usuario, Categoria categoria) {
		super();
		this.id = id;
